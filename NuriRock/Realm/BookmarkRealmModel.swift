...
final class BookmarkRealmModel: Object {
	...
	convenience init(contentid: String, contenttypeid: String, title: String, addr1: String, addr2: String, firstimage: String, overview: String, mapx: String, mapy: String) {
		self.init()
